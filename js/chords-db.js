...
const db = {
    ...
    "E_7":     { guitar: [0, 2, 0, 1, 0, 0], charango: [4, 4, 4, 2, 0], ukulele: [4, 4, 4, 2], piano: [4, 8, 11] },
    ...
    // Alias armónicos para compatibilidad con cifrados planos comunes
    "Db_major": { guitar: ["x", 4, 3, 1, 2, 1], charango: [1, 1, 1, 4, 1], ukulele: [1, 1, 1, 4], piano: [1, 5, 8] },
    "Ab_major": { guitar: [4, 6, 6, 5, 4, 4], charango: [0, 3, 4, 3, 2], ukulele: [0, 3, 4, 3], piano: [8, 12, 15] },
    "Eb_major": { guitar: ["x", "x", 1, 3, 2, 3], charango: [0, 3, 3, 1, 3], ukulele: [0, 0, 0, 1], piano: [3, 7, 10] },
    "Bb_major": { guitar: ["x", 1, 3, 3, 3, 1], charango: [3, 2, 1, 1, 1], ukulele: [3, 2, 1, 1], piano: [10, 14, 17] }
};